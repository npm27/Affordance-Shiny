...
cues$Animacy[cues$Animacy == "    NA"] = ""
cues$Animacy = as.numeric(cues$Animacy)

cues$BOI = format(round(cues$BOI, digits = 2), nsmall = 2)
cues$Concrete = format(round(cues$Concrete, digits = 2), nsmall = 2)
cues$SUBTLEX = format(round(cues$SUBTLEX, digits = 2), nsmall = 2)
cues$Animacy = format(round(cues$Animacy, digits = 3), nsmall = 2)
...
colnames(cues)[10] = "n.participant"
colnames(cues)[12] = "n.affordance"
...
<span style="color:#33a597">**Age of Acquisition (AoA):**</span> *AoA* reflects the average age at which a word is learned. Values reported in this column are taken from Kuperman et al. (2012).
...
<span style="color:#33a597">**Animacy:**</span> The *Animacy* column reflects ratings on a general living versus living scale. Higher ratings denote living creatures. Ratings are taken from VanArsdall and Blunt (2022).
