...
<span style="color:#33a597">**Note:**</span> A .csv file containing the full set of cue properties is available for download [here](https://github.com/npm27/Affordance-Shiny/blob/main/Cue%20Table.csv) or using the buttons located at the bottom of the table.
...
Table 2 provides various options for searching and filtering the affordance norms dataset. The filtered table can then be downloaded to .csv or.xlsx for further analysis. 

<span style="color:#33a597">**Note:**</span> You can download a .csv file containing the full set of affordance norms [here](https://github.com/npm27/Affordance-Norms/blob/main/4%20Analyses/R/Affordance%20Norms.csv) or using the buttons located at the bottom of the table.

### Column Descriptions

<span style="color:#33a597">**Cue:**</span> The word presented in the norming task. Participants provided open-ended responses indicating how each cue item could be used (i.e., what actions the presented object afforded).

<span style="color:#33a597">**Target:**</span> Responses to each cue. Items in the *Target* column have been lemmatized. Note that only verb responses are displayed in this table.
