...
<span style="color:#33a597">**Note:**</span> A .csv file containing the full set of cue properties is available for download [here](https://github.com/npm27/Affordance-Shiny/blob/main/Cue%20Table.csv). The data can also be downloaded or copied to the clipboard using the buttons located at the bottom of the table (Please note that you will need to scroll to the bottom of each table to access the download buttons and horizontal scrollbar).
